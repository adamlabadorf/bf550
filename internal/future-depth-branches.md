...
The archived v1 examples (`archive/examples-v1/`) retain their depth sections untouched — they are
...
>
> Worked branch-prompt examples with instructor notes: `internal/archive/examples-v1/`.
>
> ---
