...
- **Coding agents are provided and expected.** Most assignments are level 4 on the
  [AI Assessment Scale](https://aiassessmentscale.com/): use the agent freely; your design,
